#!/bin/bash
#SBATCH --job-name=lux_binned_3
#SBATCH --output=logs/lux_binned_3_%A_%a.out
#SBATCH --error=logs/lux_binned_3_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=40
...
#SBATCH -p cca
#SBATCH --mem=180G
#SBATCH --array=1020-1529

# =============================================================================
# Lux Ray-Tracing Pipeline - Part 3 of 4
# =============================================================================
#
# This script processes (model, realization) combinations 1020-1529 of 2040 total.
