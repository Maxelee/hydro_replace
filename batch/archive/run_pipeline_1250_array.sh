#!/bin/bash
#SBATCH -J pipe_1250
#SBATCH -o logs/pipe_1250_%A_%a.o
#SBATCH -e logs/pipe_1250_%A_%a.e
#SBATCH -N 8
...
# Array job for L205n1250TNG - process each snapshot in parallel
#
...
#
# Usage:
#   sbatch batch/run_pipeline_1250_array.sh
#
# After completion, run lens planes:
#   sbatch --dependency=afterok:<JOBID> batch/run_pipeline_1250_lensplanes.sh
