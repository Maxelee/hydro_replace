#!/bin/bash
#SBATCH -J pipe_625
#SBATCH -o logs/pipe_625_%A_%a.o
#SBATCH -e logs/pipe_625_%A_%a.e
#SBATCH -N 4
...
# Array job for L205n625TNG - process each snapshot in parallel
#
...
#
# Usage:
#   sbatch batch/run_pipeline_625_array.sh
#
# After completion, run lens planes:
#   sbatch --dependency=afterok:<JOBID> batch/run_pipeline_625_lensplanes.sh
