#!/bin/bash
#SBATCH --job-name=lux_binned_1
#SBATCH --output=logs/lux_binned_1_%A_%a.out
#SBATCH --error=logs/lux_binned_1_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=40
...
# =============================================================================
# Lux Ray-Tracing Pipeline - Part 1 of 4
# =============================================================================
#
# This script processes (model, realization) combinations 0-509 of 2040 total.
# 
# Models:
