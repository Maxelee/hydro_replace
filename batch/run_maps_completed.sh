...
#SBATCH -J gen_maps_done
#SBATCH -n 64
#SBATCH -N 4
#SBATCH --exclusive
#SBATCH -o /mnt/home/mlee1/hydro_replace2/logs/maps_done_%A_%a.o
#SBATCH -e /mnt/home/mlee1/hydro_replace2/logs/maps_done_%A_%a.e
#SBATCH -t 08:00:00
#SBATCH --array=0-12

# ==============================================================================
# Generate 2D maps for snapshots that already have matches completed
# ==============================================================================

# Snapshots with completed matches (as of Dec 21, 2025)
SNAPSHOTS=(29 31 33 35 38 40 41 43 46 49 59 76 99)
