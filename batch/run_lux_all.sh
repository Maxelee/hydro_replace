...
#SBATCH -J lux_raytrace
#SBATCH -n 64
#SBATCH -N 4
#SBATCH --exclusive
#SBATCH -o /mnt/home/mlee1/hydro_replace2/logs/lux_%A_%a.o
#SBATCH -e /mnt/home/mlee1/hydro_replace2/logs/lux_%A_%a.e
#SBATCH -t 24:00:00
#SBATCH --array=0-9

# ==============================================================================
# Run lux ray-tracing for all models after lens planes complete
#
# Now handles multiple seed realizations - loops over seed directories
# 
# Array indices (same as lensplanes):
#   0: DMO
#   1: Hydro
#   2-5: Replace (mass thresholds 12.5, 13.0, 13.5, 14.0)
#   6-9: BCM (all 3 BCM models, mass thresholds 12.5, 13.0, 13.5, 14.0)
#
# Submit with dependency on lensplanes:
#   sbatch --dependency=aftercorr:LENSPLANES_JOB run_lux_all.sh
# ==============================================================================
...
for ((SEED=$SEED_START; SEED<$SEED_START+$NUM_SEEDS; SEED++)); do
    ...
    # Check if lens plane files actually exist
...
# Auto-generated by run_lux_all.sh
...
echo ""
echo "=============================================="
echo "Completed ray-tracing for $MODEL_LABEL (all ${NUM_SEEDS} seeds)"
echo "=============================================="
