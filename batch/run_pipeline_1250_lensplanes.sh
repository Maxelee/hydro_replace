#!/bin/bash
#SBATCH -J pipe_1250_lp
#SBATCH -o logs/pipe_1250_lensplanes_%j.o
#SBATCH -e logs/pipe_1250_lensplanes_%j.e
#SBATCH -N 8
...
# Lens plane generation for L205n1250TNG - runs after array job completes
#
# This generates lens planes for all 21 snapshots using the replace method.
#
# Usage:
#   sbatch --dependency=afterok:<ARRAY_JOBID> batch/run_pipeline_1250_lensplanes.sh
...
mkdir -p ${LENSPLANES_DIR}/seed${SEED}
