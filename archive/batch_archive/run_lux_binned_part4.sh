#!/bin/bash
#SBATCH --job-name=lux_binned_4
#SBATCH --output=logs/lux_binned_4_%A_%a.out
#SBATCH --error=logs/lux_binned_4_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=40
...
#SBATCH -p cca
#SBATCH --mem=180G
#SBATCH --array=1530-2039

# =============================================================================
# Lux Ray-Tracing Pipeline - Part 4 of 4
# =============================================================================
#
# This script processes (model, realization) combinations 1530-2039 of 2040 total.
